...
const LIMITES_SEMINOVO_MAX_AVISTA = {
  XR: { "64GB": 999.99, "128GB": 1199.99 },

  11: { "64GB": 1199.99, "128GB": 1299.99 },
  "11 Pro": { "64GB": 1499.99 },
  "11 Pro Max": { "64GB": 1699.99 },

  12: { "64GB": 1499.99 },
  "12 Pro": { "128GB": 2199.99, "256GB": 2399.99 },
  "12 Pro Max": { "128GB": 2499.99, "256GB": 2699.99 },

  13: { "128GB": 2299.99, "256GB": 2499.99 },
  "13 Pro": { "128GB": 2799.99 },
  "13 Pro Max": { "128GB": 2900.00 },

  14: { "128GB": 2399.99 },
  "14 Pro Max": { "128GB": 3799.99, "256GB": 4099.99 },

  15: { "128GB": 3299.99 },
  "15 Plus": { "128GB": 3499.99 },
  "15 Pro": { "128GB": 4249.99, "256GB": 4399.99 },
  "15 Pro Max": { "256GB": 4899.99 },

  "16 Pro": { "128GB": 5249.99 },
  "16 Pro Max": { "256GB": 6199.99 },
};

const LIMITES_NOVO_MAX_AVISTA = {
  13: { "128GB": 3100.0, "256GB": 3500.0 },

  14: { "128GB": 3599.99, "256GB": 4099.99 },

  15: { "128GB": 4099.99, "256GB": 4699.99 },

  16: { "128GB": 4599.99, "256GB": 5499.99 },
...
function detectarProduto(texto) {
  ...
  if (ehListaDeTelas(raw) && !/\biphone\b/i.test(raw) && !/\b(64|128|256|512)\s*gb\b/i.test(raw) && !/\b\d{2,3}\s*%\b/.test(raw)) {
  return "Tela";
}
  ...
  if (/\b(s\d{1,2}|ultra)\b/i.test(t)) return "Apple Watch";
...
function extrairModelo(texto, produto) {
  ...
  if (produto === "MacBook") {
    ...
    const size = tx.match(/\b(13|14|15|16)\s*"\b/);
...
const mensagemPromo = montarMensagemPromo({
  ...
  bateriaItem,
    ...
    if (produto === "MacBook") {
  const { ram, ssd } = extrairConfigMacBook(texto);
  if (ssd) armazenamento = ssd.replace(/\s*SSD\b/i, "").trim();
}

    // ✅ Se for Tela, zera armazenamento e seta o modelo do iPhone correspondente
    if (produto === "Tela") {
      armazenamento = "";
